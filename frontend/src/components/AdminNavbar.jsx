...
const {employeeLogin} =useSelector(getemployeeData)
  ...
  const renderMobileMenu = (
    ...
    >
      ...
      {/* </MenuItem> */}
      <MenuItem>
      <Link to="/admin/employee/login" className='nav-link'>Login</Link>
      </MenuItem>
      <MenuItem>
      <Link to="/admin/employee/regsiter" className='nav-link'>Register</Link>
      </MenuItem>
  ...
  const authenticatedlinks = [
    ...
    {
      label:"Products",
      to:"/admin/employee/product",
      type:"link",
    },
    {
      label:"Add-products",
      to:"/admin/employee/add-products",
      type:"link",
    },
    {
    label:"UserList",
    to:"/admin/employee/users",
    type:"link"
    },
    {
      label:"logout",
      type:"button",
       cb:e => {
         ...
         navigate("/admin/employee/login/?r=employeelogout")
       },
    },
  ]
        ...
        <Toolbar>
          <Typography
            ...
            sx={{ display: { xs: 'none', sm: 'block' } }}>
              <Link to="/" className='nav-link'>Employe</Link>
