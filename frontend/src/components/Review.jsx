 ...
 const{userLogin} = useSelector(getUserAuthData)
  return (
    <React.Fragment>
      ...
      <List disablePadding>
        {cart.map((product) => (
          <ListItem key={product.name} sx={{ display:"flex" }}>
            <ListItemText primary={product.name} secondary={product.desc} />
            <ListItemText  primary={`Qty ${product.qty}`} />
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={6}>
          ...
          <Typography gutterBottom>{`${userLogin.house}, ${userLogin.landmark}, ${userLogin.city}, ${userLogin.pincode}, ${userLogin.state}`}</Typography>
        </Grid>
